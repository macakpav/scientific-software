module timing_module
    ...
    save
    private
    public tic,toc,startClock,stopClock,wp
...
contains
    ...
    ! toc() prints the elapsed cpu time in seconds since the most recent call of tic() (ie. tic called without output argument).
        ...
        real(wp) :: tocInternalTime, ticInternalTime, timePassed
        ...
        if ( present(elapsedTime) ) then
            ...
            print '(a,e12.4)', "Elapsed time: ", timePassed
        end if
